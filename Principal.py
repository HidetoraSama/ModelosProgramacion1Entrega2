...
while True:
    ...
    if currentScreen == 0:
        ...
        bod1w = pygame.image.load(currentClass+"-weapon.png").convert_alpha()
        bod1s = pygame.image.load(currentClass+"-shield.png").convert_alpha()
        ...
        bod2s = pygame.image.load(currentClass+"-shield.png").convert_alpha()
        screen.blit(bod2, (285, 190))
        ...
        bod3s = pygame.image.load(currentClass+"-shield.png").convert_alpha()
